...
- **Report 2:** This analysis was created for publication in [El Quantificador](https://elquantificador.org/). For this purpose, a short spanish version of the report is available at the `report_spanish` folder, as a file called `report.Rmd`. There are also the respective `.html` compilation, bibliography and references styling files. This report focuses on a mass audience.
